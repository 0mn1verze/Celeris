...
use crate::{
    HistoryTable, SearchStack, SearchStats, SearchWorker,
...
impl SearchWorker {
    ...
    pub(crate) fn ss_at(&self, offset: i16) -> SearchStackEntry {
        self.stack.at(self.ply, offset)
    }

    pub(crate) fn ss_at_mut(&mut self, offset: i16) -> &mut SearchStackEntry {
        self.stack.at_mut(self.ply, offset)
    }

    pub(super) fn piece_to_at(&self, offset: i16) -> (Piece, Square) {
